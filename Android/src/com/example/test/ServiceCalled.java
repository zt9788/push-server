...
public class ServiceCalled {
	...
	public void sendMessageResponse(String messageid, int responseCode,
		...
		if (responseCode == Cache.SEND_SUCCESS) {
			...
			intent.putExtra("status", Cache.SEND_ING);
			MyApplication.context.sendBroadcast(intent);
		}
	}
	...
	public native boolean sendMessageNative(String driveceid, String messageid,
			int type/*
					 * 0xF11=txt, 0xF22 =file
					 */, String message, List<String> sendtosomeone);
